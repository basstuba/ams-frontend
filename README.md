...
- **シンプルな操作性:** 幅広い世代のユーザーが直感的に利用可能なインターフェース。

- **管理者専用機能:** 管理者がアカウント作成や勤怠データ管理を簡単に操作できるよう設計されたUI。

- **直感的なデザイン:** ユーザーがスムーズに操作できるレスポンシブデザイン。

- **Nuxt.jsの活用:** サーバーサイドレンダリングによる高速なレンダリング。

- **柔軟な勤怠データ出力:** 勤怠データを特定の期間や条件でフィルタリングし、Excel形式で出力可能。
...
- 個人別勤怠一覧ページの勤怠確認ボタンで移動した個人の月別勤怠ページの右上にある**エクセルに出力**ボタンを押すと、表示している勤怠一覧をエクセルデータとしてダウンロードします。

#### 勤怠データ検索機能

- 個人の月別勤怠を年月で検索することができます。

- 年月の検索は2020年4月に労働基準法が改正され賃金請求権の消滅時効が5年に延長されたことを踏まえ、現在は2020年1月度まで選択可能としています。
...
- 作成用の雛形シートをご用意いたしましたので下記URLからご利用ください。また、雛形シートには10件のダミーデータを記載しています。

- スプレッドシートURL

   https://docs.google.com/spreadsheets/d/1OXB0O3aGBojU1kVIwLXo0tTojIeurTx32EYgkoB_GeE/edit?gid=0#gid=0

1. ユーザー情報の記述後メニューバーにある"ファイル"をクリック。

2. ダウンロードにカーソルを移動。

3. カンマ区切り形式（.csv）をクリックし、ダウンロードすると完了です。

##### 新規または追加で作成する場合

- 1行目は各項目の名称となりますので、2行目以降の各項目にユーザーの情報を記述してください。
